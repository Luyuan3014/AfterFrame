...
class AppLocalizations {
  ...
  static const _translations = <AppLanguage, Map<String, String>>{
    AppLanguage.chinese: {
      ...
      'studioEntryDetail': '导入 1～3 段视频，进入后选择 Live 单帧或 Live 拼图',
      'liveFrame': 'Live 单帧',
      ...
      'updateReadyToInstall': '校验通过，点按继续安装',
      ...
      'collageNeedsSources': 'Live 拼图需要至少 2 段素材；返回素材库可重新选择。',
      'collagePreviewBadge': 'After Live · 拼图',
      'collageMaterialTrack': '拼图素材',
      'collageTrackHint': '点按裁剪，长按拖动排序；预览中可拖动调整画面焦点。',
    ...
    AppLanguage.english: {
      ...
      'studioEntryTitle': 'AfterFrame Studio',
      'studioEntryDetail':
          'Import 1–3 videos, then choose Frame or Collage in Studio',
      ...
      'updateReadyToInstall': 'Verified. Tap to continue installation',
      ...
      'continueCount': 'Enter Studio ({count})',
      ...
      'collageNeedsSources':
          'Live Collage needs at least 2 clips. Return to the library to reselect.',
      'collagePreviewBadge': 'After Live · Collage',
      'collageMaterialTrack': 'Collage material',
      'collageTrackHint':
          'Tap to trim, hold to reorder, and drag the preview to adjust focus.',
