...
class AppLocalizations {
  ...
  static const _translations = <AppLanguage, Map<String, String>>{
    AppLanguage.chinese: {
      ...
      'brandCn': '余帧',
      'heroTitle': '让过去的某一帧，\n重新发生。',
      'heroSubtitle': '从视频或 Live 图里，拾起值得反复观看的瞬间。',
      'newMemory': '新的记忆',
      'startFromVideo': '开始创作',
      'startFromVideoDetail': '从视频中发现值得留下的瞬间',
      'importVideo': '导入视频',
      'tipBody': '2～6 秒的片段，最适合做成动态记忆。',
      'createSignalVideo': '视频',
      'createSignalVideoDetail': '选择片段',
      'createSignalLive': 'Live 图',
      'createSignalLiveDetail': '让瞬间流动',
      'createSignalCollage': '拼图',
      'createSignalCollageDetail': '组合新的记忆',
      ...
      'previewUnavailable': '这个作品缺少可播放的视频副本',
      'deleteWorkTitle': '删除这个作品？',
      ...
      'emptyWorksHint': '从相册选视频或 Live 图开始吧',
      'createFirst': '创建第一个作品',
      'profileTitle': '我的',
      ...
      'adaptiveQuality': '自适应高清',
      'exportQualityDetail':
          'AfterFrame 使用 Media3 以 H.264/AAC 重新编码。单帧会保留素材画幅；拼图由 Canvas First 画布决定分辨率，并在超出设备安全范围时等比缩小，绝不拉伸单个素材。当前没有会造成误解的“原画开关”。',
      'liveContainer': 'Live 容器',
      'motionPhotoAndMp4': 'Motion Photo + MP4',
      'liveContainerDetail':
          '相册版本输出为标准 JPEG XMP + 尾随 MP4 的 Motion Photo；分享给聊天或短视频应用时使用独立 MP4 副本，避免第三方重新编码图片后丢失动态元数据。兼容性最终取决于具体手机相册和接收应用。',
      'temporaryCache': '临时缓存',
      'calculating': '计算中',
      'unavailable': '暂不可用',
      'cacheFileCount': '{count} 个临时文件',
      'clearCacheTitle': '清理临时缓存？',
      'clearCacheDetail':
          '将删除缩略图、抽帧和未完成导出的临时文件。相册作品、作品索引和可分享副本不会被删除；需要时会自动重新生成缓存。',
      'clear': '清理',
      'cacheCleared': '临时缓存已清理',
      'cacheAlreadyEmpty': '当前没有可清理的临时缓存',
      ...
      'aboutLegalese': '用一帧，留住仍在发生的记忆。',
      'privacySummary':
          '隐私说明：AfterFrame 只在设备本地读取你授权的视频和 Live 图并完成编辑、导出与缓存；不会上传媒体库内容。检查更新时仅访问配置的 Gitee 发布清单与安装包。',
      'privacyAndData': '隐私与数据',
      'localProcessing': '仅本地处理',
      'privacyAndDataDetail':
          'AfterFrame 只读取系统授权给 App 的视频和 Live 图（动态照片），并在设备本地完成抽帧、编辑、Media3 编码和作品发布，不上传媒体库内容。正式作品位于系统相册，持久预览副本位于 App 私有目录；临时缓存可单独清理。只有检查或下载更新时才会访问配置的 Gitee 发布地址。卸载 App 会删除私有副本和设置，但系统相册中的已发布作品由 Android 保留。',
      'album': '作品相册',
      'albumValue': 'AfterFrame',
      'pickVideo': '选择视频',
      'pickStudioVideos': '选择创作素材',
      'pickHint': '视频和 Live 图都可导入；选 1 段做单帧，选 2～3 段自动排成拼图',
      'sourceLimit': '一个作品最多 3 段素材',
      'selectedCount': '已选择 {count} 段素材',
      'libraryEmpty': '媒体库里还没有可导入的素材',
      'libraryEmptyHint': '拍摄或保存视频、Live 图后，它们会出现在这里',
      'libraryEmptyLive': '还没有可导入的 Live 图',
      'libraryEmptyLiveHint': 'Pixel、三星、小米等相册中的动态照片会出现在这里',
      'pickFilterAll': '全部',
      'pickFilterVideo': '视频',
      'pickFilterLive': 'Live',
      'liveBadge': 'LIVE',
      ...
      'allowVideos': '允许访问视频和 Live 图',
      'permissionDetail': 'AfterFrame 只读取你选择用于创作的视频和动态照片，不会上传媒体库内容。',
      ...
      'unnamedVideo': '未命名视频',
      'errorPermission': '无法获取媒体访问权限',
      'errorLibrary': '无法读取创作素材库',
      'errorInspect': '无法读取素材信息',
      'errorThumbnail': '无法生成缩略图',
      'errorFrame': '封面提取失败',
      'errorLiveImport': '无法读取这张 Live 图的动态画面',
    ...
    AppLanguage.english: {
      ...
      'heroSubtitle':
          'Find a moment worth reliving inside a video or Live photo.',
      'newMemory': 'NEW MEMORY',
      'startFromVideo': 'Start creating',
      'startFromVideoDetail': 'Find a moment worth keeping from a video',
      'importVideo': 'Import video',
      'tipBody': 'A 2–6 second clip works best as a living memory.',
      'createSignalVideo': 'Video',
      'createSignalVideoDetail': 'Choose a clip',
      'createSignalLive': 'Live',
      'createSignalLiveDetail': 'Let it move again',
      'createSignalCollage': 'Collage',
      'createSignalCollageDetail': 'Compose a memory',
      'recentCreations': 'Recent',
      'viewAll': 'View all',
      'workTypeLive': 'Live',
      'workTypeCollage': 'Collage',
      ...
      'emptyWorksHint':
          'Choose a video or Live photo from your gallery to begin',
      ...
      'adaptiveQuality': 'Adaptive HD',
      'exportQualityDetail':
          'AfterFrame re-encodes with Media3 using H.264/AAC. A single frame keeps the source aspect ratio. A collage uses its Canvas First resolution and scales the whole canvas down only when needed for device safety; individual sources are never stretched. There is no misleading “original quality” switch.',
      'liveContainer': 'Live Container',
      'motionPhotoAndMp4': 'Motion Photo + MP4',
      'liveContainerDetail':
          'The gallery copy is a standard Motion Photo using JPEG XMP with a trailing MP4. Sharing to chat or short-video apps uses a separate MP4 copy so image re-encoding cannot strip motion metadata. Final compatibility depends on the phone gallery and receiving app.',
      'temporaryCache': 'Temporary Cache',
      'calculating': 'Calculating',
      'unavailable': 'Unavailable',
      'cacheFileCount': '{count} temporary files',
      'clearCacheTitle': 'Clear temporary cache?',
      'clearCacheDetail':
          'This removes thumbnails, extracted frames, and unfinished export files. Gallery works, the work index, and shareable copies are kept. Cache is regenerated when needed.',
      'clear': 'Clear',
      'cacheCleared': 'Temporary cache cleared',
      'cacheAlreadyEmpty': 'There is no temporary cache to clear',
      'cacheClearFailed': 'Unable to clear cache. Try again later.',
      'bytesValue': '{value} B',
      'kbValue': '{value} KB',
      'mbValue': '{value} MB',
      'about': 'About AfterFrame',
      'versionUnavailable': 'Version unavailable',
      'aboutLegalese': 'Keep one frame, and let the memory keep moving.',
      'privacySummary':
          'Privacy: AfterFrame reads only videos and Live photos you authorize and performs editing, export, and caching on this device. It does not upload your media library. Update checks contact only the configured Gitee release manifest and package.',
      'privacyAndData': 'Privacy & Data',
      'localProcessing': 'On-device only',
      'privacyAndDataDetail':
          'AfterFrame reads only videos and Live photos granted by the system and performs frame extraction, editing, Media3 encoding, and publishing on this device. It does not upload your media library. Published works live in the system gallery; persistent preview copies live in app-private storage, while temporary cache can be cleared separately. Network access is used only for the configured Gitee update manifest and package. Uninstalling removes private copies and settings, while Android keeps works already published to the system gallery.',
      'album': 'Saved Album',
      'albumValue': 'AfterFrame',
      'pickVideo': 'Choose Video',
      'pickStudioVideos': 'Choose Studio Material',
      'pickHint':
          'Import videos or Live photos. Pick 1 clip for a single frame, or 2–3 for an auto collage',
      'sourceLimit': 'A moment holds up to 3 clips',
      'selectedCount': '{count} selected',
      'libraryEmpty': 'No importable clips in your library',
      'libraryEmptyHint':
          'Videos and Live photos you capture or save will appear here',
      'libraryEmptyLive': 'No Live photos to import yet',
      'libraryEmptyLiveHint':
          'Motion photos from Pixel, Samsung, and Xiaomi albums appear here',
      'pickFilterAll': 'All',
      'pickFilterVideo': 'Video',
      'pickFilterLive': 'Live',
      'liveBadge': 'LIVE',
      ...
      'allowVideos': 'Allow access to videos and Live photos',
      'permissionDetail':
          'AfterFrame only reads videos and motion photos you choose for creation and never uploads your library.',
      ...
      'addSource': 'Add clip',
      'addSourceHint': 'Room for {count} more — they become a Live collage',
      'removeSource': 'Remove this clip',
      'sourceRemoved': 'Clip removed',
      'editCollageClip': 'Trim clip {index}',
      'editCollageClipHint':
          'Each clip keeps its own range and cover; playback syncs to the shortest active range.',
      'smartCropHint':
      ...
      'coverAndRange': 'Cover & range',
      'coverClipLabel': 'Clip {index}',
      'clipCover': 'This clip’s cover',
      ...
      'errorPermission': 'Unable to access your media',
      'errorLibrary': 'Unable to read the media library',
      'errorInspect': 'Unable to read media details',
      'errorThumbnail': 'Unable to create a thumbnail',
      'errorFrame': 'Unable to extract the cover frame',
      'errorLiveImport': 'Unable to read motion from this Live photo',
