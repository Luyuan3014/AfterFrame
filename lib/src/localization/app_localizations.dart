...
class AppLocalizations {
  ...
  static const _translations = <AppLanguage, Map<String, String>>{
    AppLanguage.chinese: {
      ...
      'privacySummary':
          '隐私说明：AfterFrame 只在设备本地读取你授权的视频并完成编辑、导出与缓存；不会上传媒体库内容。检查更新时仅访问配置的 Gitee 发布清单与安装包。',
      'privacyAndData': '隐私与数据',
      'localProcessing': '仅本地处理',
      'privacyAndDataDetail':
          'AfterFrame 只读取系统授权给 App 的视频，并在设备本地完成抽帧、编辑、Media3 编码和作品发布，不上传媒体库内容。正式作品位于系统相册，持久预览副本位于 App 私有目录；临时缓存可单独清理。只有检查或下载更新时才会访问配置的 Gitee 发布地址。卸载 App 会删除私有副本和设置，但系统相册中的已发布作品由 Android 保留。',
      'album': '作品相册',
