...
class AppLocalizations {
  ...
  static const _translations = <AppLanguage, Map<String, String>>{
    AppLanguage.chinese: {
      ...
      'newMemory': '新的记忆',
      'startFromVideo': '开始创作',
      'startFromVideoDetail': '1 段成 Live 单帧，2～3 段自动排成拼图',
      'importVideo': '导入素材',
      'tipBody': '2～6 秒的片段，最适合做成动态记忆。',
      'createSignalVideo': '视频',
      'createSignalVideoDetail': '截取仍在发生的瞬间',
      'createSignalLive': 'Live 图',
      'createSignalLiveDetail': '让静止的画面重新呼吸',
      'createSignalCollage': '拼图',
      'createSignalCollageDetail': '2～3 段自动成画',
      'myWorks': '我的余帧',
      'previewWork': 'Live 预览',
    ...
    AppLanguage.english: {
      ...
      'startFromVideoDetail':
          '1 clip becomes a Live frame; 2–3 become an auto collage',
      'importVideo': 'Import',
      'tipBody': 'A 2–6 second clip works best as a living memory.',
      'createSignalVideo': 'Video',
      'createSignalVideoDetail': 'Lift a moment that is still moving',
      'createSignalLive': 'Live',
      'createSignalLiveDetail': 'Let a still photograph breathe again',
      'createSignalCollage': 'Collage',
      'createSignalCollageDetail': '2–3 clips, arranged automatically',
      'myWorks': 'My Moments',
