...
class AppLocalizations {
  ...
  static const _translations = <AppLanguage, Map<String, String>>{
    AppLanguage.chinese: {
      ...
      'studioEntryDetail': '视频和 Live 图都可导入；选 1 段做单帧，选 2～3 段自动排成拼图',
      'newMemory': '新的记忆',
      'startFromVideo': '从视频或 Live 图开始',
      'startFromVideoDetail': '选择视频或动态照片，捕捉你的动态记忆',
      'importVideo': '导入素材',
      'tipTitle': '余帧提示',
      ...
      'canvasTrackHint': '点按裁剪，长按拖动排序，× 移除，＋ 添加；版式随素材比例自动优化，只剩 1 段时回到单帧。',
      'addSource': '添加素材',
      ...
      'coverMoment': '封面瞬间',
      'chooseCover': '选择封面瞬间',
      'chooseCoverHint': '点选格子或下方素材切换当前段，每段 Live / 视频可单独选择封面。',
    ...
    AppLanguage.english: {
      ...
      'startFromVideo': 'Start with video or Live',
      'startFromVideoDetail':
          'Choose a video or motion photo and capture a living memory',
      'importVideo': 'Import Material',
      ...
      'canvasTrackHint':
          'Tap to trim, hold to reorder, × to remove, ＋ to add. Layout adapts to source ratios, and one remaining clip returns to a single frame.',
      'addSource': 'Add clip',
      ...
      'chooseCoverHint':
          'Select a tile, then pick its still. Each Live or video has its own cover.',
