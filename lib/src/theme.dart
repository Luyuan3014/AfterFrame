  ...
  static ThemeData get dark {
    ...
    return ThemeData(
      ...
      textTheme: const TextTheme(
        displaySmall: TextStyle(fontSize: 38, fontWeight: FontWeight.w800, height: 1.02, letterSpacing: -1.8),
        headlineMedium: TextStyle(fontSize: 27, fontWeight: FontWeight.w700, letterSpacing: -1),
        titleLarge: TextStyle(fontSize: 20, fontWeight: FontWeight.w700, letterSpacing: -.4),
