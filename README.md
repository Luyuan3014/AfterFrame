...
- 创作页单一导入入口：一张主卡片进入素材库，视频 / Live 图 / 拼图只作能力说明，不再并列第二套 Studio 入口
...
- AfterFrame Studio：单帧用一条轴同时选封面和 LIVE 范围；拼图用素材轨点选当前段再调封面与裁剪；导出只在顶栏
- 实况播放：点按后画面轻微放大，结束或再次点击回到封面静帧；编辑、全屏和作品预览一致
